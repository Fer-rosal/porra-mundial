...
export const MATCH_DATA: MatchDataPoint[] = [
  ...
  { match_number: 73, phase_key: 'R16', home_team: 'Group A runners-up', away_team: 'Group B runners-up', scheduled_at: '2026-06-28T20:00:00Z', venue: 'Los Angeles Stadium' },
  { match_number: 74, phase_key: 'R16', home_team: 'Group E winners', away_team: 'Group A/B/C/D/F third place', scheduled_at: '2026-06-29T16:00:00Z', venue: 'Boston Stadium' },
  { match_number: 75, phase_key: 'R16', home_team: 'Group F winners', away_team: 'Group C runners-up', scheduled_at: '2026-06-29T20:00:00Z', venue: 'Estadio Monterrey' },
  { match_number: 76, phase_key: 'R16', home_team: 'Group C winners', away_team: 'Group F runners-up', scheduled_at: '2026-06-29T23:00:00Z', venue: 'Houston Stadium' },
  { match_number: 77, phase_key: 'R16', home_team: 'Group I winners', away_team: 'Group C/D/F/G/H third place', scheduled_at: '2026-06-30T16:00:00Z', venue: 'New York New Jersey Stadium' },
  { match_number: 78, phase_key: 'R16', home_team: 'Group E runners-up', away_team: 'Group I runners-up', scheduled_at: '2026-06-30T20:00:00Z', venue: 'Dallas Stadium' },
  { match_number: 79, phase_key: 'R16', home_team: 'Group A winners', away_team: 'Group C/E/F/H/I third place', scheduled_at: '2026-06-30T23:00:00Z', venue: 'Mexico City Stadium' },
  { match_number: 80, phase_key: 'R16', home_team: 'Group L winners', away_team: 'Group E/H/I/J/K third place', scheduled_at: '2026-07-01T16:00:00Z', venue: 'Atlanta Stadium' },
  { match_number: 81, phase_key: 'R16', home_team: 'Group D winners', away_team: 'Group B/E/F/I/J third place', scheduled_at: '2026-07-01T20:00:00Z', venue: 'San Francisco Bay Area Stadium' },
  { match_number: 82, phase_key: 'R16', home_team: 'Group G winners', away_team: 'Group A/E/H/I/J third place', scheduled_at: '2026-07-01T23:00:00Z', venue: 'Seattle Stadium' },
  { match_number: 83, phase_key: 'R16', home_team: 'Group K runners-up', away_team: 'Group L runners-up', scheduled_at: '2026-07-02T16:00:00Z', venue: 'Toronto Stadium' },
  { match_number: 84, phase_key: 'R16', home_team: 'Group H winners', away_team: 'Group J runners-up', scheduled_at: '2026-07-02T20:00:00Z', venue: 'Los Angeles Stadium' },
  { match_number: 85, phase_key: 'R16', home_team: 'Group B winners', away_team: 'Group E/F/G/I/J third place', scheduled_at: '2026-07-02T23:00:00Z', venue: 'BC Place Vancouver' },
  { match_number: 86, phase_key: 'R16', home_team: 'Group J winners', away_team: 'Group H runners-up', scheduled_at: '2026-07-03T16:00:00Z', venue: 'Miami Stadium' },
  { match_number: 87, phase_key: 'R16', home_team: 'Group K winners', away_team: 'Group D/E/I/J/L third place', scheduled_at: '2026-07-03T20:00:00Z', venue: 'Kansas City Stadium' },
  { match_number: 88, phase_key: 'R16', home_team: 'Group D runners-up', away_team: 'Group G runners-up', scheduled_at: '2026-07-03T23:00:00Z', venue: 'Dallas Stadium' },

  // ── R8 PHASE — 8 matches (Round of 16) ──────────────────────────────────────
  { match_number: 89, phase_key: 'R8', home_team: 'Winner match 74', away_team: 'Winner match 77', scheduled_at: '2026-07-04T16:00:00Z', venue: 'Philadelphia Stadium' },
  { match_number: 90, phase_key: 'R8', home_team: 'Winner match 73', away_team: 'Winner match 75', scheduled_at: '2026-07-04T20:00:00Z', venue: 'Houston Stadium' },
  { match_number: 91, phase_key: 'R8', home_team: 'Winner match 76', away_team: 'Winner match 78', scheduled_at: '2026-07-05T16:00:00Z', venue: 'New York New Jersey Stadium' },
  { match_number: 92, phase_key: 'R8', home_team: 'Winner match 79', away_team: 'Winner match 80', scheduled_at: '2026-07-05T20:00:00Z', venue: 'Mexico City Stadium' },
  { match_number: 93, phase_key: 'R8', home_team: 'Winner match 83', away_team: 'Winner match 84', scheduled_at: '2026-07-06T16:00:00Z', venue: 'Dallas Stadium' },
  { match_number: 94, phase_key: 'R8', home_team: 'Winner match 81', away_team: 'Winner match 82', scheduled_at: '2026-07-06T20:00:00Z', venue: 'Seattle Stadium' },
  { match_number: 95, phase_key: 'R8', home_team: 'Winner match 86', away_team: 'Winner match 88', scheduled_at: '2026-07-07T16:00:00Z', venue: 'Atlanta Stadium' },
  { match_number: 96, phase_key: 'R8', home_team: 'Winner match 85', away_team: 'Winner match 87', scheduled_at: '2026-07-07T20:00:00Z', venue: 'BC Place Vancouver' },

  // ── R4 PHASE — 4 matches (Quarter-finals) ───────────────────────────────────
  { match_number: 97, phase_key: 'R4', home_team: 'Winner match 89', away_team: 'Winner match 90', scheduled_at: '2026-07-09T20:00:00Z', venue: 'Boston Stadium' },
  { match_number: 98, phase_key: 'R4', home_team: 'Winner match 93', away_team: 'Winner match 94', scheduled_at: '2026-07-10T20:00:00Z', venue: 'Los Angeles Stadium' },
  { match_number: 99, phase_key: 'R4', home_team: 'Winner match 91', away_team: 'Winner match 92', scheduled_at: '2026-07-11T16:00:00Z', venue: 'Miami Stadium' },
  { match_number: 100, phase_key: 'R4', home_team: 'Winner match 95', away_team: 'Winner match 96', scheduled_at: '2026-07-11T20:00:00Z', venue: 'Kansas City Stadium' },

  // ── R2 PHASE — 2 matches (Semi-finals) ──────────────────────────────────────
  { match_number: 101, phase_key: 'R2', home_team: 'Winner match 97', away_team: 'Winner match 98', scheduled_at: '2026-07-14T23:00:00Z', venue: 'Dallas Stadium' },
